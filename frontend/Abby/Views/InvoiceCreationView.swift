...
struct InvoiceCreationView: View {
        ...
        ZStack{
            ...
            Form {
                ...
                Section {
                    ...
                    .listRowBackground(formValid ? Color("ButtonColour") : Color.gray)
    ...
    private var formValid: Bool {
        ...
        !controller.invoice.items.isEmpty &&
        controller.invoice.items.contains(where: { !$0.description.isEmpty && $0.quantity > 0 && $0.unit_price > 0 })
    }
}
